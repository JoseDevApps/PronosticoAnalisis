...
fileObs = 'MesObservacionesEnergia.csv' # nombre del archivo csv observado
fileWRF = 'MesWRF.csv' # nombre del archivo csv WRF extraido previamente
datetimetagObs = 'Clock' # nombre de la etiqueta para la columna datetime
...
nombreOut = 'UyuniMesPruebaEnergia' # nombre del archivo de salida despues de juntarlos en un mismo dataframe
# Lectura observados
